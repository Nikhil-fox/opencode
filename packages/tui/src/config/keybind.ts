...
export const Definitions = {
  ...
  dir_delete: keybind("ctrl+d", "Delete additional directory"),
  ...
  permission_auto_accept_toggle: keybind("ctrl+a", "Toggle auto-accept mode for edit permissions"),
  ...
  input_line_home: keybind("home", "Move to start of line in input"),
