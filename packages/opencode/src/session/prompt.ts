...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
      ...
      // Architect mode handling (independent of plan mode)
...
You should build your design incrementally by writing to or editing this file. NOTE that this is the only file you are allowed to edit - other than the only allowed to take READ-ONLY actions.
...
NOTE: At any point in time with this workflow you should feel free to ask the user questions or clarifications. Don't make large assumptions about user intent. The goal is to present a well researched design to the user, and tie any loose ends before implementation begins.
</system-reminder>`,
          synthetic: true,
        })
        userMessage.parts.push(part)
...
NOTE: At any point in time through this workflow you should feel free to ask the user questions or clarifications. Don't make large assumptions about user intent. The goal is to present a well researched plan to the user, and tie any loose ends before implementation begins.
    ...
    const resolveTools = Effect.fn("SessionPrompt.resolveTools")(function* (input: {
      ...
      const context = (args: any, options: ToolExecutionOptions): Tool.Context => ({
        ...
        extra: { model: input.model, bypassAgentCheck: input.bypassAgentCheck, additionalDirectories, promptOps },
        ...
        while (true) {
          ...
          const outcome: "break" | "continue" = yield* Effect.gen(function* () {
            ...
            const [skills, env, instructions, modelMsgs] = yield* Effect.all([
              sys.skills(agent),
              Effect.sync(() => sys.environment(model, additionalDirectories)),
